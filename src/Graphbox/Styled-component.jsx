...
export const BorderBox = styled(Box)(({ isBorder1, isBorder2, isBorder3, isBorder4, isBorder5 }) => ({
    borderTop: isBorder1 ? "2px solid #8369F1" : isBorder2 ? "2px solid #FB7269" : isBorder3 ? "2px solid #FACC25" : isBorder4 ? "2px solid #74C951" : isBorder5 ? "2px solid #AFE31F" : "",
}))
