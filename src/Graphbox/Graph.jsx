...
//   ];
  ...
  const TopGrossignItem = [
    {
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyIyh1LQ1srGbgpJQOwX7V-qPp5I9wuPYAtvq0FoSwWRz0UIauOqkyTtY1k9RSPVqis0c&usqp=CAU",
      name: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
      price: "15487",
    },
    {
        img: "https://images.deliveryhero.io/image/fd-pk/Products/5926920.jpg?width=%s",
        name: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
        price: "15487",
      },
      {
        img: "https://images.deliveryhero.io/image/fd-pk/Products/1965245.jpg?width=%s",
        name: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
        price: "15487",
      },
    ...
    <ParentBox>
      ...
      <GridContainer container>
        <GridSeling item xl={6} lg={6} md={6} sm={12} xs={12}>
          <SellingGridBox>
            <Box>
              <Typography>Top selling item</Typography>
            </Box>
            ...
            <Box>
              ...
              >
                ...
                <Box sx={{ width: "25%" }}>${item.price}</Box>
              </List>
            </Box>
            ))}
          </SellingGridBox >
